...
<div class="container my-5">
    ...
    <div class="shadow-3-strong mt-4">
        <div class="d-flex p-4 head-order-history" style="cursor: pointer;">
            ...
            <span class="ms-auto fw-bold">{{ date_format(date_create($order->created_at), 'H:i d/m/Y') }}</span>
        </div>
        <div class="body-order-history">
            ...
            @endforeach
            <form action="{{ route('order-accept', $order->id) }}" method="post" class="pb-4 px-4 text-end">
                @csrf
